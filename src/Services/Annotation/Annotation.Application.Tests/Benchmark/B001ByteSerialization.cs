...
public class B001ByteSerialization
{
    ...
    {
        Summary summary = BenchmarkRunner.Run<IntegerByteSerializerBenchmark>(
            ManualConfig
    ...
    {
        Summary summary = BenchmarkRunner.Run<FloatByteSerializerBenchmark>(
            ManualConfig
                .Create(DefaultConfig.Instance)
                .WithOptions(ConfigOptions.DisableOptimizationsValidator));
    ...
    {
        Summary summary = BenchmarkRunner.Run<DoubleByteSerializerBenchmark>(
            ManualConfig
                .Create(DefaultConfig.Instance)
                .WithOptions(ConfigOptions.DisableOptimizationsValidator));
    ...
    {
        Summary summary = BenchmarkRunner.Run<LongByteSerializerBenchmark>(
            ManualConfig
                .Create(DefaultConfig.Instance)
                .WithOptions(ConfigOptions.DisableOptimizationsValidator));
