...
namespace PreciPoint.Ims.Services.Annotation.Application.DeckGl.Serialization.Attribute.LineColor;

public class AnnotationLineColorAttributeSerializer : IAttributeSerializer
{
    private readonly IByteSerializer _serializer;

    public AnnotationLineColorAttributeSerializer(IByteSerializer serializer)
    {
    ...
    {
        header.ThrowIfNotAttributeHeaderPresent(DeckGlDataAccessor.GetLineColor, out AttributeHeaderDto attribute);
